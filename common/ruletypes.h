...
RULE_STRING(World, SupportedClients, "Titanium", "Comma-delimited list of clients to restrict to. Supported values are Titanium | SoF | SoD | UF. Example: Titanium,RoF2")
...
RULE_INT(NPC, MaxRaceID, 474, "Maximum Race ID, RoF2 by default supports up to 732")
...
RULE_BOOL(NPC, AllowGlobalMultiQuest, true, "Enable Multiquest for all NPC")
RULE_CATEGORY_END()
